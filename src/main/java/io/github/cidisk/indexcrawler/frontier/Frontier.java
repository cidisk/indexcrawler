...
import io.github.cidisk.indexcrawler.frontier.Counters.ReservedCounterNames;
...
public class Frontier extends Configurable {
  ...
  public Frontier(Environment env, CrawlConfig config) {
    ...
    try {
      workQueues = new WorkQueues(env, "PendingURLsDB", config.isResumableIndexCrawling());
