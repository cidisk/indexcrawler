...
package io.github.cidisk.indexcrawler.url;
 ...
 * 
 * modified by Cai Duo to adapt index specific fish search
 */
...
public class WebURL implements Serializable {
	...
	private short depth; // record depth of fish search
	private String domain;
	private String subDomain;
	private String path;
	private String anchor; //indeed anchor text
	private byte priority;
	private String tag; // record anchor name

	// 新增Node Position记录节点节点在dom树上的path
	...
	/**
	 * @return node in which this URL in dom(node's path like "/html/body/div/div/a/span")
	 * */
