...
public class HtmlParseData implements ParseData {
	...
	private Set<WebURL> outgoingIndexUrls;
	private Set<WebURL> infoUrls;
	...
	@Override
	public void setOutgoingIndexUrls(Set<WebURL> outgoingUrls) {
		this.outgoingIndexUrls = outgoingUrls;
	}
	@Override
